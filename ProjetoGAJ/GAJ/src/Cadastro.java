...
public class Cadastro extends JFrame {
	private ImageIcon img = new ImageIcon("../imgs/nome.jpg");
	private JPanel p;
	...
	private ImageIcon imgbt = new ImageIcon("../imgs/efet.png");
	private JButton bt = new JButton(imgbt);
	
	private ImageIcon cancela = new ImageIcon("../imgs/can.png");
	private JButton can = new JButton(cancela);
	
	private ImageIcon lin = new ImageIcon("../imgs/linha.png");
